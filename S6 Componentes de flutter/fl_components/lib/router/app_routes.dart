...
class AppRoutes{
  ...
  static List<MenuOption> menuOptions = [
    ...
    MenuOption(view: const ListViewBuilderScreen(), name: "ListView Builder Screen", icon: const Icon(Icons.build,color: AppTheme.primaryLigthColor), route: 'listviewbuilder_screen'),
